...
async Task ConcurrencyChecksAsync() //cip...113
{
    ...
    team.Name = "New Team with concurrency check 1"; //Tivoli Gardens FC
...
async Task InsertOneRecordAsync() //cip...49
{
    ...
    {
        Name = $"New League with audit ({DateTime.Now})",
        CreatedDate = DateTime.Now //cip...108 now not needed as the SaveChangesAsync() will set it automatically.
    };
